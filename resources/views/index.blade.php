<x-guest-layout>
    ...
    <header class="bg-[#DEF6FD] md:mt-2 rounded-md text-center md:text-left">
        <div class="container mx-auto py-10 md:py-40 bg-contain bg-no-repeat bg-[right_0px_top_10px]">
            ...
            <form action="" method="get" class="mt-4">
                <div class="flex bg-white items-center p-4">
                    <div class="basis-1/3 md:basis-3/6 relative">
                        ...
                        <input type="search" class="pl-12 md:pl-16 outline-none focus:outline-none font-thin w-full"
                    ...
                    <div class="basis-1/3 md:basis-1/6">
                        <button
                            class="transition bg-red-500 text-white p-3 px-8 hover:opacity-75 rounded-full w-full ml-3">Search</button>
                    </div>
                </div>
            </form>
            ...
            <p class="mt-6 text-gray-600">
                ...
                <span class="text-gray-400">
                    Designer, Developer, PHP, HTML, CSS, Javascript, Jquery
                </span>
            </p>
        </div>
    </header>
    ...
    <section id="categories" class="mt-12">
        <div class="container mx-auto">
            ...
            <div class="flex flex-row gap-2 items-center text-center flex-wrap md:flex-nowrap pl-4 md:pl-0">
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FCF1EB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/bootstrap.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">Bootstrap</h4>
                    <p class="text-gray-500 text-xs">
                        32 Courses
                    </p>
                </div>
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FEF9EC] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/html.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#E4F4FB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/jquery.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        Jquery
                    </h4>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#E4F4FB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/sass.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        Sass
                    </h4>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FCF1EB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/react.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        React
                    </h4>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FEF9EC] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/java.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        Java
                    </h4>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FCF1EB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/python.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        Python
                    </h4>
                ...
                <div
                    class="transition basis-[45%] md:basis-[12.5%] bg-[#FCF1EB] cursor-pointer rounded mr-3 p-5 hover:opacity-75 group hover:-translate-y-2">
                    <div class="bg-white rounded-full m-0 mx-auto w-20 h-20 p-2.5 scale-90 group-hover:scale-125">
                        <img src="{{ asset('images/icons/mongodb.png') }}" alt="bootstrap" class="w-16 h-16">
                    </div>
                    <h4 class="font-medium mt-4 mb-2">
                        MongoDB
                    </h4>
    ...
    <section id="popular-courses" class="mt-12">
        <div class="container mx-auto">
                        ...
                        <div class="mt-3 p-3">
                            ...
                            <div class="mt-3 mb-4 text-xs">
                                ...
                                <div class="mt-5 flex items-center">
                                    <img src="{{ asset('images/avatar1.png') }}" alt="avatar1" class="w-8 h-8 rounded-full z-0">
                                    <img src="{{ asset('images/avatar2.png') }}" alt="avatar1"
                                        class="w-8 h-8 rounded-full z-10 -ml-4">
                                    <img src="{{ asset('images/avatar3.png') }}" alt="avatar1"
                                        class="w-8 h-8 rounded-full z-10 -ml-4">
                                    <img src="{{ asset('images/avatar1.png') }}" alt="avatar1"
                                        class="w-8 h-8 rounded-full z-10 -ml-4">
                                    <div
