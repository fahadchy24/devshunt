...
<nav class="bg-white shadow p-2.5 sticky top-0 z-50">
        ...
        <div class="flex justify-between">
            <div class="flex justify-center items-center">
                ...
                <div class="hidden md:block ml-8 group relative">
                    <img src="{{ asset('images/icons/category-icon.svg') }}" alt="category-icon" class="w-8 h-8 cursor-pointer">
                    <div class="bg-white absolute hidden group-hover:block min-w-[200px]">
                        <ul class="list-none">
                            <li>
                ...
                <div class="hidden md:block ml-16 relative">
                    ...
                    <input type="search" class="transition w-full min-w-[300px] text-xs rounded-md p-3 pl-10 bg-slate-100 outline-none outline-1 focus:outline-red-300" placeholder="Search for Tuts, Videos, Tutors etc">
                </div>
            </div>
            <div class="flex justify-center items-center pr-4 md:pr-0">
                <ul class="list-none">
                    <li class="inline-block mx-3 sm:mx-4 md:mx-6 relative group">
                        <a href="#" class="text-xl text-gray-500 group-hover:opacity-75">
                            <span class="absolute -top-2 bg-red-500 -right-3.5 text-white pl-1.5 text-sm rounded-full h-5 w-5">
                                2
                            </span>
                ...
                <div class="hidden md:block -mt-3 mx-3 group">
                    <a href="#" class="text-xl text-gray-500 group-hover:opacity-75 rounded-full h-5 w-5 shadow py-1.5 px-2.5">
    ...
    <div class="mobile-navbar w-0 h-[102vh] bg-white absolute top-0 left-0 text-left shadow overflow-y-auto transition-all">
        <div class="text center pt-2 flex items-center">
            <a href="index.html" class="m-0 mx-auto mt-3">
                <img src="{{ asset('images/logo.png') }}" alt="logo" class="w-36">
            </a>
        </div>
        <div class="p-3">
            <div class="relative">
                ...
                <input type="search" class="transition w-full text-xs rounded-md p-3 pl-12 bg-slate-100 outline-none outline-1 focus:outline-red-300" placeholder="Search for Tuts, Videos, Tutors etc">
            </div>
            <div class="mt-3">
                <ul class="mt-3 list-none">
                    ...
                    <li class="transition p-3 cursor-pointer hover:bg-slate-100 mb-1 hover:opacity-80">
