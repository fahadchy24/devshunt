<x-guest-layout>
    ...
    <section id="courses-page" class="mt-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-7 grid-flow-row auto-rows-max gap-5">
                ...
                <div class="md:col-span-5 course-lists-area">
                    <div class="flex justify-between">
                        ...
                        <div>
                            <div class="bg-gray-100 w-24 h-12">
                                <i class="fa-solid fa-list text-2xl py-1 px-3.5 text-gray-500 cursor-pointer"></i>
                                <i class="fa-solid fa-table-cells text-2xl text-gray-800 cursor-pointer"></i>
                            </div>
                        </div>
                    </div>
                    <div class="course-lists mt-4">
                        <div class="flex flex-col md:flex-row md:flex-wrap gap-5 flex-wrap">
                        ...
                        <div class="mt-10">
                            <div class="flex justify-between">
                                <a href="#"
                                    class="transition w-10 h-10 border border-gray-200 py-1.5 px-3.5 hover:bg-gray-300">
                                    <i class="fa-solid fa-chevron-left"></i>
                                </a>
                                <a href="#"
                                    class="mr-3 transition w-10 h-10 border border-gray-200 py-1.5 px-3.5 hover:bg-gray-300">
                                    <i class="fa-solid fa-chevron-right"></i>
                                </a>
                            </div>
                        </div>
